...
- (void)updateConditionLabel {
    ...
    NSArray<NSString *> *labels = @[
                                    NSLocalizedString(@"object-condition.description.unknown", @"A description for an object's condition that is unknown (Scale 0/5)."),
                                    NSLocalizedString(@"object-condition.description.none", @"A description for an object's condition that is good. (Scale 1/5)"),
                                    NSLocalizedString(@"object-condition.description.minor", @"A description for an object's condition that is fair. (Scale 2/5)"),
                                    NSLocalizedString(@"object-condition.description.moderate", @"A description for an object's condition that is moderate. (Scale 3/5)"),
                                    NSLocalizedString(@"object-condition.description.severe", @"A description for an object's condition that is severe. (Scale 4/5)"),
                                    NSLocalizedString(@"object-condition.description.collapsed", @"A description for an object's condition that is destroyed. (Scale 5/5)"),
                                    ];
