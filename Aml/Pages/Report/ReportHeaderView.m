...
- (UITextField *)titleField {
    if (!_titleField) {
        ...
        titleField.placeholder = NSLocalizedString(@"placeholder.report-title", @"Placeholder text for the title of a report.");
...
- (UITextField *)assessorEmailField {
    if (!_assessorEmailField) {
        ...
        assessorEmailField.placeholder = NSLocalizedString(@"placeholder.email", @"Placeholder text for the email of a report.");
